...
( username ,
 password )
 VALUES
('huy@gmail.com', '$10$zwpBqEc3Ase7e7I.0MtLsOv4xvkSaqkg5mPh9f03IW8p3MAcZi6n.');

INSERT INTO occupationdb.`users`
(username,
password)
VALUES
('binhbe@gmail.com', '$10$zwpBqEc3Ase7e7I.0MtLsOv4xvkSaqkg5mPh9f03IW8p3MAcZi6n.');
...
`contact_email`)
VALUES
('Nguyễn Công Bình', 'Be', '0316425387', 'Tầng 16, Tòa Nhà Sai Gon Tower, 29 Lê Duẩn, Phường Bến Nghé, Quận 1, Thành phố Hồ Chí Minh, Việt Nam', 'be-logo.png', 'Thành phố Hồ Chí Minh', 'binhbe@gmail.com');
...
comp_id)
VALUES
('Tài xế BeBike', 'Tài xế BeBike đảm nhận trách nhiệm vận chuyển hành khách một cách an toàn và hiệu quả. Bằng cách điều khiển xe ô tô một cách chuyên nghiệp và tuân thủ nghiêm ngặt các quy tắc giao thông, tài xế đưa hành khách đến đích đã được chỉ định. Ngoài ra, nhiệm vụ còn bao gồm bảo dưỡng xe đúng kỳ hạn và báo cáo về tình trạng kỹ thuật nếu có vấn đề.', 'Để trở thành một tài xế BeBike, ứng viên cần sở hữu bằng lái xe hạng A1, cùng với kỹ năng lái xe an toàn và hiệu quả. Ngoài ra, khả năng giao tiếp tốt và thái độ thân thiện là yếu tố quan trọng. Ứng viên cũng cần hiểu rõ địa bàn làm việc và có kỹ năng sửa xe cơ bản để thực hiện các công việc bảo dưỡng.', 'Tài xế BeBike sẽ được hưởng mức thu nhập hấp dẫn, cùng với các chế độ bảo hiểm y tế và xã hội. Chế độ làm việc linh hoạt giúp phản ánh nhu cầu cá nhân của nhân viên. Ngoài ra, công ty còn cung cấp cơ hội đào tạo và phát triển nghề nghiệp, cũng như cơ hội thăng tiến cho những người có hiệu suất làm việc xuất sắc.', 5, 60000000, 10000000, 'Vận tải hành khách', '2023/12/31', 0, 'Hồ Chí Minh', 4);
